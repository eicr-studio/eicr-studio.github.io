...
description: "Understand Euclidean and SE(2) uncertainty, retraction and local covariance."
weight: 10
draft: false
---
...
See the [state-space API](/blackwell/api/spaces/) for every Euclidean and SE(2) operation.
