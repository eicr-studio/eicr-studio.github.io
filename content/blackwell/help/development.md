...
The package currently reports version `0.0.0` and is installed from GitHub. A public release should define a versioning and compatibility policy, publish wheel and source distributions, and add release notes before PyPI publication.
